...
; Aut2Exe Settings
;===============================================================================================================
#AutoIt3Wrapper_Icon=Resources\Icons\Bravin.ico				;~ Filename of the Ico file to use for the compiled exe
#AutoIt3Wrapper_OutFile_Type=exe								;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
#AutoIt3Wrapper_OutFile=..\Bravin.exe							;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\Bravin_X64.exe					;~ Target exe filename for X64 compile.
...
;===============================================================================================================
#AutoIt3Wrapper_Res_Comment=Bravin									;~ Comment field
#AutoIt3Wrapper_Res_Description=Bravin						      	;~ Description field
...
#AutoIt3Wrapper_Res_Field=ProductName|Bravin
...
; Remove resources
#AutoIt3Wrapper_Res_Icon_Add=Resources\Icons\BravinH.ico							; 201
...
Global $g_sProgShortName		= "Bravin"
Global $g_sProgShortName_X64	= $g_sProgShortName & "_X64"
Global $g_sProgName				= "Bravin"
...
Global $g_sBrowserPath		 = @ProgramFilesDir & "\BraveSoftware\Brave-Browser\Application\brave.exe"
Global $g_sExtendedProcs	 = ""
...
Global $g_sAboutCredits		= "Derick Payne (Rizonesoft), Brian J Christy (Beege), " & _
							"G Sandler (MrCreatoR), Holger Kotsch, KaFu, LarsJ, nickston, ProgAndy, Yashied" & _
							"Bravin by @marlonteixeira"
...
Func _StartCoreGui()
	...
	GUICtrlSetOnEvent($g_hBtnSave, "_SaveBravinConfig")
	...
	GUICtrlSetState($g_hChkStartWindows, FileExists(@StartupDir & "\" & $g_sProgShortName & ".lnk"))
...
Func _SaveBravinConfig()
	...
	If GUICtrlRead($g_hChkStartWindows) = $GUI_CHECKED Then
		FileDelete(@StartupDir & "\" & $g_sProgShortName & ".lnk")
		FileCreateShortcut(@ScriptFullPath, @StartupDir & "\" & $g_sProgShortName & ".lnk", @StartupDir)
	Else
		FileDelete(@StartupDir & "\" & $g_sProgShortName & ".lnk")
	EndIf
